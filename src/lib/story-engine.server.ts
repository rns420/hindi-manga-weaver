...
export async function buildPlan(args: {
  ...
  const raw = await chat({
    ...
    messages: [
      ...
      {
        role: "user",
        content: `नीचे अंग्रेजी में एक कहानी का सारांश दिया है। इसे अच्छे से समझो और इस पर एक बहुत लंबी हिंदी मंगा कहानी का पूरा प्लान बनाओ।
...
प्लान में ठीक ${BASE_CHAPTERS} अध्याय होने चाहिए। हर अध्याय का शीर्षक और दो से तीन लाइन का ब्यौरा हिंदी में लिखो कि उस अध्याय में क्या होगा, कौन से किरदार होंगे, कौन सा मोड़ आएगा और कौन सी भावना उभरेगी। कहानी में हुक, ट्विस्ट, सस्पेंस, हँसी, ड्रामा और इमोशन बराबर फैले होने चाहिए। आखिरी अध्याय खुला अंत देगा।

जवाब सिर्फ इस जेसन ढाँचे में दो और कुछ नहीं:
{"title": "कहानी का हिंदी शीर्षक", "chapters": [{"title": "अध्याय का हिंदी शीर्षक", "brief": "हिंदी में ब्यौरा"}]}`,
      },
    ],
  });

  const parsed = extractJson(raw) as { title?: string; chapters?: Chapter[] };
  ...
  if (chapters.length < 8) throw new Error("plan too short");
  ...
  return {
    title: normalizeTitle(String(parsed.title ?? "")),
    chapters: chapters.slice(0, BASE_CHAPTERS),
  };
}
